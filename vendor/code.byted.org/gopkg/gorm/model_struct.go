...
// ModelStruct loanmodel definition
...
// TableName get loanmodel's table name
func (s *ModelStruct) TableName(db *DB) string {
	return DefaultTableNameHandler(db, s.defaultTableName)
}

// StructField loanmodel field's struct definition
...
// GetModelStruct get value's loanmodel struct, relationships based on struct and tag definition
...
// GetStructFields get loanmodel's field structs
