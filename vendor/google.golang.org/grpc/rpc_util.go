...
// Code returns the error code for err if it was produced by the loanrpc system.
...
// ErrorDesc returns the error description of err if it was produced by the loanrpc system.
